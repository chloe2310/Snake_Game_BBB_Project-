...
static const struct of_device_id ssd1306_of_match[] = {
    { .compatible = "ssd1306_screen_device" },
    {}
};
...
static int __init ssd1306_init(void)
{
    ...
    if (device_create(mdev.m_class, NULL, mdev.dev_num, NULL, "my_ssd1306") == NULL)
    {
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Chloe");
MODULE_DESCRIPTION("SSD1306 OLED kernel driver");